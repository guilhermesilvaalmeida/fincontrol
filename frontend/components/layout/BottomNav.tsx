...
export function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-20 flex border-t border-ink-100 bg-surface-card px-1 pb-[env(safe-area-inset-bottom)] dark:border-white/10 dark:bg-surface-cardDark md:hidden">
      {links.map((link) => {
